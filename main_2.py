...
class SpaceShip(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.mage = pygame.transform.rotate(pygame.transform.scale(pygame.image.load(SPACESHIP_IMG).convert_alpha(), (int(WINDOW_WIDTH * 0.2), int(WINDOW_WIDTH * 0.2))), 180.0)
